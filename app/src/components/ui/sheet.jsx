  ...
  ({ className, children, side = "left", ...props }, ref) => (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 gap-4 bg-background p-0 shadow-xl data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-400",
          side === "right" &&
